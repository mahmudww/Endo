...
const endingText = {
    eng: {
        ...
        p4: "The cursed song ends here. The responsibility does not.",
        playAgain: "PLAY AGAIN"
    },
    ind: {
        eyebrow: "TAMAT",
        title: "PERJALANAN PANJANG, AWAL YANG BARU",
        p1: "Setelah perjalanan melewati ketakutan, korupsi, dan irama yang tak pernah berhenti, akhirnya kamu berdiri di hadapan Dororo, Raja Tirani, yang telah tumbang.",
        ...
        p4: "Lagu kutukannya berakhir di sini. Tapi tanggung jawabnya tidak.",
...
function rhythmLoop() {
    ...
    if (stageTimeElement) stageTimeElement.textContent = Math.ceil(game.stageTimeRemaining);
